...
本中文文档是本人业余所为,所以不能保证更新的进度.如果你想要提前了解更多,可以参考 `Theorem of Beethoven`_ 编写的 `英文文档`_ (但也不完善).另外推荐YouTube频道上的Theorem of Beethoven频道,其专门制作Manim教程,比较系统;Bilibili上有搬运教程,但由于版权问题,就不在这里给出链接.本文档有很多地方也都是参考Theorem of Beethoven的视频资料和文档.
...
.. toctree::
   ...
   0_faq_others/faq.rst
   0_faq_others/vscode.rst
